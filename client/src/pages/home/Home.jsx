...
export default function Home() {
  ...
  return (
    <div className=" bg-gradient-to-br from-gray-800 to-blue-950 text-white min-h-screen flex flex-col items-center justify-center p-10">
      <div className="flex flex-col md:flex-row items-center justify-evenly w-full max-w-6xl">
        ...
        >
          <h1 className="text-6xl font-bold bg-clip-text font-poppins text-transparent bg-gradient-to-r from-red-600 to-yellow-400">
            ComuniQ
          </h1>
